...
const files = [
  {
    ...
    size: 'June 5, 2021',
    source:
    'https://www.ricardos.com/wp-content/uploads/2020/02/lpic-1-zertifikat.png',
    current: true,
  },
  // More files...
]
const currentFile = {
  name: 'IZTECH Linux 101 Summer Camp',
  size: 'Created Date : June 5, 2021',
  source:
  'https://www.ricardos.com/wp-content/uploads/2020/02/lpic-1-zertifikat.png',
  information: {
    'Issued by': 'Izmir Instutde of Tecnology',
    'Issued at': 'June 5, 2021',
    'Expire date': 'June 1, 2050',
  ...
  sharedWith: [
    ...
    },
    {
      ...
      name: 'Email',
      imageUrl:
        'https://www.pngkit.com/png/detail/0-7693_mail-comments-mail-icon-png.png',
    },
  ],
}
...
export default function Example() {
 ...
 <main className="pt-8 pb-16">
        <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">        {/* Narrow sidebar */}
          ...
          <div className="flex-1 flex items-stretch overflow-hidden">
            <main className="flex-1 overflow-y-auto">
              <div className="pt-8 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex">
                  <h1 className="flex-1 text-2xl font-medium text-gray-900">All Issued Certificates for Address
                  <div className="text-xl font-normal">
                  0x3302b52C5147e89bEca2b0CBBb66A15d1882541c
                  </div>
                   </h1>
