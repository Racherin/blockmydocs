...
const steps = [
    { id: 'Step 1', name: 'Create Network', href: '#', status: 'complete' },
    { id: 'Step 2', name: 'Upload JSON', href: '#', status: 'complete' },
    { id: 'Step 3', name: 'Select Template', href: '#', status: 'upcoming' },
    { id: 'Step 3', name: 'Upload Certificates', href: '#', status: 'upcoming' },
  ]
